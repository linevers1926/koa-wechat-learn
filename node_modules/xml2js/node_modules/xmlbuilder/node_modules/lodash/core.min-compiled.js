...
;(function () {
  function n(n) {
    ...
    var i = -1,
      ...
      var f = n[i];0 < r && e(f) ? 1 < r ? s(f, r - 1, e, u, o) : t(o, f) : u || (o[o.length] = f);
    }return o;
  }function h(n, t) {
    return n && On(n, t, In);
  }function v(n, t) {
    ...
    return n === t || (null == n || null == t || !H(n) && !K(t) ? n !== n && t !== t : g(n, t, r, e, b, u));
  }function g(n, t, r, e, u, o) {
    var i = Nn(n),
        c = Nn(t),
        f = "[object Array]",
        a = "[object Array]";i || (f = hn.call(n), f = "[object Arguments]" == f ? "[object Object]" : f), c || (a = hn.call(t), a = "[object Arguments]" == a ? "[object Object]" : a);var l = "[object Object]" == f,
        c = "[object Object]" == a,
        a = f == a;o || (o = []);
    ...
    var u = !r;r || (r = {});for (var o = -1, i = t.length; ++o < i;) {
      ...
      if (f === nn && (f = n[c]), u) r[c] = f;else {
        var a = r,
            l = a[c];pn.call(a, c) && M(l, f) && (f !== nn || c in a) || (a[c] = f);
      }
    }return r;
  }function F(n) {
    ...
    }if (typeof n != "function") throw new TypeError("Expected a function");var u = S(n);return e;
    ...
    var i = 1 & r,
        ...
        f = c.length,
        a = In(t).length;
    if (f != a && !i) return false;for (var l = f; l--;) {
    ...
    var t = [];if (null != n) for (var r in Object(n)) t.push(r);return t;
  }function q(n, t, r) {
    return t = jn(t === nn ? n.length - 1 : t, 0), function () {
      for (var e = arguments, u = -1, o = jn(e.length - t, 0), i = Array(o); ++u < o;) i[u] = e[t + u];for (u = -1, o = Array(t + 1); ++u < t;) o[u] = e[u];return o[t] = r(i), n.apply(this, o);
    };
  }function $(n) {
    ...
    var u = In(r),
        o = v(r, u);null != e || H(r) && (o.length || !u.length) || (e = r, r = n, n = this, o = v(r, In(r)));var i = !(H(e) && "chain" in e && !e.chain),
        c = V(n);
    return mn(o, function (e) {
      var u = r[e];n[e] = u, c && (n.prototype[e] = function () {
        var r = this.__chain__;if (i || r) {
          var e = n(this.__wrapped__);return (e.__actions__ = E(this.__actions__)).push({ func: u, args: arguments, thisArg: n }), e.__chain__ = r, e;
  ...
  var mn = function (n, t) {
    ...
    N(t, I(t), n);
      ...
      Rn = F(function (n, t, r, e) {
    N(t, qn(t), n, e);
  }),
      Dn = x(function (n) {
    return n.push(nn, c), Rn.apply(nn, n);
  }),
      In = _n,
      qn = I,
      $n = function (n) {
    ...
    var n = arguments.length;if (!n) return [];for (var r = Array(n - 1), e = arguments[0]; n--;) r[n - 1] = arguments[n];return t(Nn(e) ? E(e) : [e], s(r, 1));
  ...
  }, o.iteratee = _, o.keys = In, o.map = function (n, t) {
    return d(n, _(t));
    ...
    var e = null == n ? 0 : n.length;return r = r === nn ? e : +r, e ? A(n, null == t ? 0 : +t, r) : [];
    ...
    return H(n) ? Nn(n) ? E(n) : N(n, _n(n)) : n;
  }, o.escape = function (n) {
    ...
    var n = {};return h(o, function (t, r) {
      pn.call(o.prototype, r) || (n[r] = t);
    }), n;
  }(), { chain: false }), o.VERSION = "4.17.2", mn("pop join replace reverse split push shift sort splice unshift".split(" "), function (n) {
